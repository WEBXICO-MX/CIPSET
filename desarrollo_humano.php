...
<html lang="es">
    <head>
        <title>CIPSET &#124; Desarrollo humano</title>
        <meta charset="UTF-8">        
    ...
    <body>
        ...
        <div class="container">            
            <div class="row">
                <div class="col-md-12">
                    <h1>Desarrollo humano</h1><br/>
                </div>
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            <img src="img/desarrollo_humano.jpg" alt="Desarrollo humano" class="img-responsive" style="margin: 0 auto;"/><br/>
