...
<html lang="es">
    <head>
        <title>CIPSET &#124; Servicio de apoyo a pozos</title>
        <meta charset="UTF-8">        
    ...
    <body>
        ...
        <div class="container">            
            <div class="row">
                <div class="col-md-12">
                    <h1>Servicio de apoyo a pozos</h1><br/>
                </div>
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            <img src="img/servicios_apoyo_pozos.jpg" alt="Servicio de apoyo a pozos" class="img-responsive" style="margin: 0 auto;"/><br/>
                        ...
                        <div class="col-md-6">
                            <h2>Cursos</h2>
                            <ul>
                                <li>Básico de soldadura con arco eléctrico</li>
                                <li>Certificación de soldadores</li>
                                <li>Supervisor de Línea de Acero</li>
                                <li>Malacate de producción línea de acero</li>
                                <li>Presiones y muestreo de fondo</li>
                                <li>Mantenimiento a Sistemas Neumático (silos y plantas de cemento)</li>
                            </ul>
                        </div>
                    </div>
                </div>
