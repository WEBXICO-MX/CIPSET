...
-- Tiempo de generación: 04-08-2017 a las 10:25:55
...
(1, 12, '2016-07-30', '2016-08-30', 1, 1, '2016-06-15 11:49:17', '2017-08-04 07:48:46', b'0'),
(2, 12, '2016-09-30', '2016-10-29', 2, 1, '2016-07-15 12:12:28', '2017-08-04 07:48:50', b'0');
...
CREATE TABLE IF NOT EXISTS `instructores` (
  ...
  `CVE_ESPECIALIDAD` int(11) DEFAULT NULL,
  `RUTA_FOTO` varchar(50) DEFAULT NULL,
  ...
  PRIMARY KEY (`ID`),
  KEY `INDEX_1` (`ID`),
  KEY `FK_REFERENCE_13` (`CVE_PERSONA`),
  KEY `FK_REFERENCE_14` (`CVE_ESPECIALIDAD`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `instructores_capacitaciones`
--

CREATE TABLE IF NOT EXISTS `instructores_capacitaciones` (
  `CVE_INSTRUCTOR` int(11) NOT NULL,
  `CVE_CAPACITACION` int(11) NOT NULL,
  `FECHA_REGISTRO` datetime DEFAULT NULL,
  `FECHA_MODIFICACION` datetime DEFAULT NULL,
  `ACTIVO` bit(1) DEFAULT NULL,
  PRIMARY KEY (`CVE_INSTRUCTOR`,`CVE_CAPACITACION`),
  KEY `INDEX_1` (`CVE_INSTRUCTOR`,`CVE_CAPACITACION`),
  KEY `FK_REFERENCE_16` (`CVE_CAPACITACION`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
