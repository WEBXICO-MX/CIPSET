...
<html lang="es">
    <head>
        <title>CIPSET &#124; LEAN MANUFACTURING</title>
        <meta charset="UTF-8">        
    ...
    <body>
        ...
        <div class="container">            
            <div class="row">
                <div class="col-md-12">
                    <h1>LEAN MANUFACTURING</h1><br/>
                </div>
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            <img src="img/lean_manufacturing.jpg" alt="LEAN MANUFACTURING" class="img-responsive" style="margin: 0 auto;"/><br/>
                        ...
                        <div class="col-md-6">
                            <h2>Cursos</h2>
                            <ul>
                                <li>Introducción a Lean Manufacturing </li>
                                <li>Lean Accounting </li>
                                <li>Lean Six Sigma </li>
                                <li>Taller de 5 S´s y Control Visual </li>
                                <li>Value Stream Mapping </li>
                                <li>Kan Ban</li> 
                                <li>SMED </li>
                                <li>Poka Yoke </li>
                                <li>Mantenimiento Productivo Total (TPM) </li>
                                <li>Metodología del Pensamiento Esbelto </li>
                                <li>Identificación y Eliminación de Desperdicios </li>
                                <li>Celdas de Manufactura </li>
                                <li>Estandarización de Operaciones </li>
                                <li>Tack Time y Balanceo de líneas</li> 
                                <li>Mejora Continua (Kaizen) </li>
                                <li>Mejoras Rápidas (Short Kaizen) </li>
                            </ul>
                            <h2>Diplomados</h2>
                            <ul>
