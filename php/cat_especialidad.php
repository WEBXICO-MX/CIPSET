...
<html lang="es">
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <br/>
                    <br/>
                    <table id="tabla_especialidades" class="table table-bordered table-striped table-hover table-responsive">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Nombre</th>
        ...
        <script src="../js/php/cat_especialidad.min.js"></script>
        <script>
                $(document).ready(function () {
                    $('#tabla_especialidades').DataTable({responsive: true,
                        "order": [[0, "desc"]]
                    });
                });
        </script>
