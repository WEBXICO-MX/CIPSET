...
<html lang="es">
    <head>
        <title>CIPSET &#124; Corporativo Integral para Soluciones en Tiempo &#124; Conócenos</title>
        <meta charset="UTF-8">        
        ...
        <div class="container">            
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <p><strong>Email de contacto:</strong> <a href="mailto:contacto@cipset.net">contacto@cipset.net</a></p>
                </div>
                <div class="col-sm-12">
