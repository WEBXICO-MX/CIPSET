...
<html lang="es">
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <br/>
                    <br/>
                    <table id="tabla_tipos_medios" class="table table-bordered table-striped table-hover table-responsive">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Nombre</th>
        ...
        <script src="../js/php/cat_tipos_medios_comunicacion.min.js"></script>
        <script>
            $(document).ready(function(){
                $('#tabla_tipos_medios').DataTable({responsive: true,
                    "order": [[0, "desc"]]
                });
            });
        </script>        
