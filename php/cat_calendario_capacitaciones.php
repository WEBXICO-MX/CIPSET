    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <br/>
                    <br/>
                    <table id="tabla_calendario_capacitaciones" class="table table-bordered table-striped table-hover table-responsive">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Capacitación</th>
        ...
        <script>
                $(document).ready(function () {
                    $('#tabla_calendario_capacitaciones').DataTable({responsive: true,
                        "order": [[0, "desc"]]
                    });
                });
        </script>
